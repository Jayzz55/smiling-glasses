...
config[:casper] = {
  blog: {
    ...
    name: 'Smiling Glasses',
    description: 'My rants, ideas, and thoughts on internet ,software development, and techs',
    date_format: '%d %B %Y',
    navigation: true,
    logo: nil # Optional
  },
  author: {
    name: 'Jaya Wijono',
    bio: 'a plain guy who just love techs', # Optional
    location: 'Melbourne, Australia', # Optional
    website: 'http://jayzz55.github.io/', # Optional
